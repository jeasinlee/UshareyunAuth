...
import cn.ushare.account.admin.portal.service.WiredPortalService;
 ...
 * @Author jixiang.lee
 * @Description
 * @Date create in 13:56 2019/11/9
 * @Modified BY
 */
@Api(tags = "WiredPortalController", description = "WiredPortal接口")
@RestController
@Slf4j
@RequestMapping("/wired")
public class WiredPortalController {
    ...
    @Autowired
    WiredPortalService portalService;
    @Autowired
    ...
    public BaseResult getAuthParam(@RequestBody String paramJson) throws Exception {
        log.debug("wired getAuthParam method");
