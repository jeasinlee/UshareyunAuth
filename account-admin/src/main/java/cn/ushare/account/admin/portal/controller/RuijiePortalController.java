...
import cn.ushare.account.admin.portal.service.RuijiePortalService;
 ...
 */
@Api(tags = "RuijiePortalController", description = "RuijiePortal接口")
@RestController
@Slf4j
@RequestMapping("/ruijie")
public class RuijiePortalController {
    ...
    @Autowired
    RuijiePortalService portalService;
    @Autowired
    ...
    public BaseResult getAuthParam(@RequestBody String paramJson) throws Exception {
        log.debug("ruijie getAuthParam method");
