...
import cn.ushare.account.admin.portal.service.H3cPortalService;
 ...
 * 常见错误：参考华为
 */
@Api(tags = "H3cPortalController", description = "H3cPortal接口")
@RestController
@Slf4j
@RequestMapping("/h3c")
public class H3cPortalController {
    ...
    @Autowired
    H3cPortalService portalService;
    @Autowired
    ...
    public BaseResult getAuthParam(@RequestBody String paramJson) throws Exception {
        log.debug("h3c getAuthParam method");
