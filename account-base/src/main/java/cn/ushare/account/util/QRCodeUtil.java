...
public class QRCodeUtil {
     ...
     * @param name     生成的二维码图片名称
     * @param size     生成的二维码图片尺寸 可以自定义或者默认（250）
     * @param logoPath logo的存放位置
     */
    public static boolean zxingCodeCreate(String content, String path, 
            String name, Integer size, String logoPath) {
        try {
            //图片类型
