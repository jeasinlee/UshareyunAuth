...
public class RSAEncryptionBak {
    ...
    private static final String INIT_SEEDS = "ushareyun@2019";
    ...
    private static void initKey() throws Exception {
        ...
        secrand.setSeed(INIT_SEEDS.getBytes());// 初始化随机产生器
    ...
    public static void main(String[] args) throws Exception {
        ...
        RSAEncryptionBak das = new RSAEncryptionBak();

        String datastr = "ushareyun";
        ...
        String str1 = "before";
        String str2 = "after";
        String sign = RSAEncryptionBak.sign(str1.getBytes());
