...
public final class AESUtilBak {
    ...
    private static void verifySign(String sign, String data) throws Exception {
        ...
        if (falg) {
            ...
            //私钥解密
            byte[] decryptData = AESUtilBak.decryptByPrivateKey(endcryptData, privateKey);
    ...
    public static String encrypt(String plaintext) {
        ...
        try {
            byte[] endcryptData = AESUtilBak.encryptByPublicKey(plaintext.getBytes(), publicKey);
    ...
    public static String decryption(String ciphertext) {
        ...
        try {
            byte[] decryptData = AESUtilBak.decryptByPrivateKey(Base64.decodeBase64(ciphertext), privateKey);
...
//            System.out.println("私钥：\t"+Base64.encodeBase64String(privateKey));
        ...
        byte[] endcryptData = AESUtilBak.encryptByPublicKey(inputStr, publicKey);
